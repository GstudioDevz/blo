...
namespace settings
{
	...
	namespace magicbullet
	{
		...
		inline int tp_iterations{ 8000 };     // write iterations for stable teleport
	}
	...
	namespace visuals
	{
		...
		// Overlay FPS cap (0 = uncapped)
		inline int overlay_fps_cap{ 60 };
	...
	// Generic teleport saved locations (simple in-memory store)
	namespace teleport
	{
		...
		inline std::vector<location_entry> saved_locations;
