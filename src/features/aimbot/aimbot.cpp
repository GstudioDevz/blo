...
static void pf_koios_aimbot()
{
	...
	auto koios_look_at = [](const math::vector3& from, const math::vector3& to) -> math::matrix3
	{
	...
	math::matrix3 target_matrix = koios_look_at(camera_pos, target_pos);
